...
function App() {
  ...
  const setCustomThemes = (theme) => {
    localStorage.setItem("theme", theme)
    setChangeThemes(!changeThemes)
  }



  useEffect(() => {
    const customThemes = localStorage.getItem("theme") === null ? "" : localStorage.getItem("theme");
    ...
    <>
      ...
      <Routes>
        ...
        <Route path='/user/search' element={
          <RequireAuth loginPath={'/auth'}> <Search /></RequireAuth>
        } />
      ...
      {/* btn is available inside top-bar custom themes for change the theme. Below its dialog box */}
