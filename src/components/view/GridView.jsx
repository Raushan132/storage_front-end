        ...
        <div>
            <div>
                ...
                <div className='grid grid-cols-4 mx-4 gap-6'>
                    {folders.map(folder => {
                        return (
                            <div className='text-lg flex items-center w-48 rounded-lg px-4 py-2 justify-between bg-base-300 '>
            ...
            <div>
                ...
                <div className='grid grid-cols-4 mx-4 gap-6'>
                    {files.map(file => {
                        return (
                            <div className='text-md flex items-center w-56 rounded-lg px-4 py-2 justify-between bg-base-300 '>
                                <div className='flex justify-center gap-2 items-center'>
